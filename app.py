...
Original file is located at
    https://colab.research.google.com/drive/1s9sptGKlv76mSNk9vDFNEyEX9aZwMVqg
...
GOOGLE_API_KEY = userdata.get('GOOGLE_APIKEY')
...
embeddings = GoogleGenerativeAIEmbeddings(model="models/gemini-embedding-001", google_api_key=userdata.get("GOOGLE_APIKEY"))
...
This cell will generate a `requirements.txt` file, which lists all the Python packages required for this notebook to run. This is useful for sharing your project and ensuring reproducibility.
"""
...
def generate_requirements_file(output_filename='requirements.txt'):
    """
    Generates a requirements.txt file with all currently installed packages.
    """
    installed_packages = pkg_resources.working_set
    with open(output_filename, 'w') as f:
        for p in installed_packages:
            f.write(f'{p.project_name}=={p.version}\n')
    print(f'Successfully generated {output_filename}')

generate_requirements_file()

"""The `requirements.txt` file has been created in your current working directory. You can now download it and include it in your GitHub repository."""
